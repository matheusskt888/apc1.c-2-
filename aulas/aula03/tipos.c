...
int main (){
  ...
  printf("a faixa de valor de char vai de %i ate %i\n", CHAR_MIN, CHAR_MAX);
  printf("a faixa de valor de int vai de %i ate %i\n", INT_MIN, INT_MAX);
  printf("a faixa de valor de float vai de %i ate %i\n", FLT_MIN, FLT_MAX);
  printf("a faixa de valor de double vai de %E ate %E\n", DBL_MIN, DBL_MAX);
  ...
  printf(" a faixa de valores do unsigned int vai de %i ate %i\n", 0, UINT_MAX);
  printf(" a faixa de valores do unsigned long int vai de %i ate %i\n", 0, ULONG_MAX);
